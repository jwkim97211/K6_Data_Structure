...
public class ch04_2_array {
	public static void main(String[] args) {
		...
		Instack4 s = new Instack4(4); // 최대 64 개를 푸시할 수 있는 스택
		...
		while (true) {
			...
			case 1: // 푸시
				...
				try {
					s.push(x);
				} catch (Instack4.OverflowIntStackException e) {
			...
			case 2: // 팝
				...
				} catch (Instack4.EmptyIntStackException e) {
